...
def main():
 ...
 t=' '.join(texts(q))
 for x in ['Cheirisophus has not returned','Insufficient ships','Persons over forty','Philesius and Sophaenetus','eight thousand six hundred','captives sold','tithe for Apollo and Artemis',"Xenophon's own name and that of Proxenus",'deposited with Megabyzus','later campaign, banishment, and settlement at Scillus','location indicated by an oracle','river named Selinus','annually tithes','Citizens and neighboring men and women','goddess is said to provide',"Xenophon's sons","sacred estate's economy",'small-scale copy of Ephesus','yearly tithe sacrifice and shrine repair','note (5) continued onto page 101']:
