...
PRIMARY_UNIT_IDS = ["XEN-PRI-RU-001", "XEN-PRI-RU-002", "XEN-PRI-RU-003"]
PRIMARY_UNIT_PATHS = {
...
NEXT_PRIMARY_UNIT_ID = "XEN-PRI-RU-004"
...
def main() -> int:
    ...
    if manifest.get("version") != "1.3.0":
        print("Manifest version must be 1.3.0 after drafting Anabasis I.3")
        return 1
