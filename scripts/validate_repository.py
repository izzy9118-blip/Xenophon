...
PRIMARY_UNIT_IDS = [f"XEN-PRI-RU-{number:03d}" for number in range(1, 5)]
PRIMARY_UNIT_PATHS = {
...
NEXT_PRIMARY_UNIT_ID = "XEN-PRI-RU-005"
...
def main() -> int:
    ...
    if manifest.get("version") != "1.4.0":
        print("Manifest version must be 1.4.0 after drafting Anabasis I.4")
        return 1
