...
PRIMARY_UNIT_IDS = [f"XEN-PRI-RU-{number:03d}" for number in range(1, 9)]
PRIMARY_UNIT_PATHS = {
...
NEXT_PRIMARY_UNIT_ID = "XEN-PRI-RU-009"
...
def main() -> int:
    ...
    if manifest.get("artificial_intelligence_self_certification_prohibited") is not True:
        ...
        return 1
    if manifest.get("version") != "1.8.0":
        print("Manifest version must be 1.8.0 after drafting Anabasis I.8")
        return 1
